...
// subsampling factor).
void pjpeg_load_from_file(int *x, int *y, int *comps, pjpeg_scan_type_t *pScan_type, int reduce, uint8 * pImage)
{
...
//------------------------------------------------------------------------------
int picojpg_test(FILE * pic_stream, int * width, int * height, int * comps, uint8 * bitmap)
{
